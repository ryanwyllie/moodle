...
define(
     ...
     */
    var setActiveItem = function(root, item, pubSub) {
        ...
        pubSub.publish(PagedContentEvents.SHOW_PAGES, eventPayload);
    };
    ...
    var init = function(root, pubSub) {
        ...
        if (activeItem.length) {
            ...
            setActiveItem(root, activeItem, pubSub);
        }
        ...
        root.on(CustomEvents.events.activate, SELECTORS.DROPDOWN_ITEM, function(e, data) {
            ...
            setActiveItem(root, item, pubSub);
