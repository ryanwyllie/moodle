...
define(['jquery', 'core/str', 'core/custom_interaction_events'],
    ...
    MdlPopoverController.prototype.events = function() {
        return {
            ...
            contentScrollBottom: 'mdlpopover:contentScrollBottom',
        };
    };
    ...
    MdlPopoverController.prototype.registerBaseEventListeners = function() {
        ...
        // Trigger the contentScrollBottom event if the user scrolls to the bottom
        // of the content area.
        this.getContentContainer().scroll(function(e) {
            var scrollTop = this.getContentContainer().scrollTop();
            var innerHeight = this.getContentContainer().innerHeight();
            var scrollHeight = this.getContentContainer()[0].scrollHeight;

            if (scrollTop + innerHeight >= scrollHeight) {
                this.root.trigger(this.events().contentScrollBottom);
            }
