...
define(
    ...
    var getActivePageNumber = function(root) {
        return root.attr('data-active-page-number');
    };
    ...
    var registerEventListeners = function(root) {
        ...
        root.on(PagedContentEvents.ALL_ITEMS_SHOWN, function(e, pageNumber) {

        });

        root.on(PagedContentEvents.PAGES_SHOWN, function() {

        });

        root.on(PagedContentEvents.SET_ITEMS_PER_PAGE_LIMIT, function(e, limit) {
