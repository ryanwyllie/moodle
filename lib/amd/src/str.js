...
define(['jquery', 'core/ajax', 'core/localstorage'], function($, ajax, storage) {
    ...
    return /** @alias module:core/str */ {
        ...
        get_strings: function(requests) {
            ...
            for (i = 0; i < requests.length; i++) {
                ...
                if (typeof request.lang === "undefined") {
                    request.lang = this.get_page_lang();
                }
        ...
        /**
         * Get the lang string set on the page's HTML element.
         *
         * @method get_page_lang
         * @return {string}
         */
        get_page_lang: function() {
            return $('html').attr('lang');
        },

        /**
         * Checks if right-to-left language is enabled on the page.
         *
         * @method is_rtl_enabled
         * @return {bool}
         */
        is_rtl_enabled: function() {
