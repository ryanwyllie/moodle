 ...
 * @since      3.2
 */
define(['jquery', 'core/modal_factory', 'core/modal_events', 'core/modal_registry',
        'core/templates', 'core/modal_test'],
        function($, ModalFactory, ModalEvents, ModalRegistry, Templates, ModalTest) {

    ModalRegistry.register('MODAL_TEST', ModalTest, 'core/modal_test_6');
    ...
    var init = function() {
        ...
        var trigger5 = $('#runtime-modal');
        ModalFactory.create({
            type: 'MODAL_TEST',
            title: 'Run time registered modal',
        }, trigger5);
    };
