...
define(['jquery'], function($) {
    ...
    var init = function(formElement, invalidEventName, validEventName, indicateValid) {
        ...
        var showErrorStyles = (typeof invalidEventName != 'undefined');
        var showSuccessStyles = (typeof validEventName != 'undefined');
        ...
        // Remove all styling if the form is reset.
        formElement.on('reset', function(e) {
            if (showSuccessStyles) {
                formElement.find('.has-success').removeClass('has-success');
                formElement.find('.form-control-success').removeClass('form-control-success');
            }

            if (showErrorStyles) {
                formElement.find('.has-danger').removeClass('has-danger');
                formElement.find('.form-control-danger').removeClass('form-control-danger');
            }
        });
    };
