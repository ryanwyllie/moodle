...
define(['jquery', 'core/templates', 'core/notification', 'core/key_codes',
     ...
     *
     * @param {jQuery object} root The root element for the modal
     * @return Modal
     */
    ...
    Modal.prototype.countOtherVisibleModals = function() {
        ...
        $('body').find(SELECTORS.CONTAINER).each(function(index, element) {
            ...
            if (!this.root.is(element) && element.hasClass('visible')) {
                count++;
            }
        }.bind(this));
     ...
     *
     * @method setBody
     * @param {string or jQuery promise} value The body string or promise
     */
     ...
     *
     * @method setFooter
     * @param {string or jQuery promise} value The footer string or promise
     */
     ...
     * @param {jQuery event} e The tab key event
     */
    ...
    Modal.prototype.registerEventListeners = function() {
        ...
        this.getModal().on(CustomEvents.events.activate, SELECTORS.HIDE, function() {
            this.hide();
        }.bind(this));
    };
