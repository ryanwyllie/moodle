...
define([
    ...
    return /** @alias module:core/templates */ {
        ...
        getTemplateSource: function(templateName) {
            ...
            require([modulename], function(System) {
                ...
                if (!(system instanceof IconSystem)) {
                    ...
                    system.init()
                        .then(function() {
                            return renderer.getTemplate(iconSystem.getTemplateName());
                        })
                        .then(ready.resolve)
            ...
            return $.when.apply(null, [ready.promise, renderer.cachePartials(templateName)])
                .then(function(ignore, templateSource) {
                    return templateSource;
                });
        },
        ...
        addHelpers: function(context, themeName) {
            var renderer = new Renderer();
            renderer.addHelpers(context, config.theme);
            return context;
        }
    };
});
