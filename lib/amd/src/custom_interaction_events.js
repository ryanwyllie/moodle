...
define(['jquery', 'core/key_codes'], function($, keyCodes) {
     ...
     * @private
     * @param eventType name of the event (see events above)
     * @param inlcude the list of events to be added
     ...
     * @private
     * @param element jQuery object to add event listeners to
     */
    ...
    var addEscapeListener = function(element) {
        element.off('keydown.cie.escape').on('keydown.cie.escape', function(e) {
            if (!isModifierPressed(e)) {
                if (e.keyCode == keyCodes.escape) {
                    $(e.target).trigger(events.escape, [{originalEvent: e}]);
                }
            }
        });
    };
    ...
    var addDownListener = function(element) {
        element.off('keydown.cie.down').on('keydown.cie.down', function(e) {
            if (!isModifierPressed(e)) {
                if (e.keyCode == keyCodes.arrowDown) {
                    $(e.target).trigger(events.down, [{originalEvent: e}]);
                }
            }
        });
    };
    ...
    var addUpListener = function(element) {
        element.off('keydown.cie.up').on('keydown.cie.up', function(e) {
            if (!isModifierPressed(e)) {
                if (e.keyCode == keyCodes.arrowUp) {
                    $(e.target).trigger(events.up, [{originalEvent: e}]);
                }
            }
        });
    };
    ...
    var addHomeListener = function(element) {
        element.off('keydown.cie.home').on('keydown.cie.home', function(e) {
            if (!isModifierPressed(e)) {
                if (e.keyCode == keyCodes.home) {
                    $(e.target).trigger(events.home, [{originalEvent: e}]);
                }
            }
        });
    };
    ...
    var addEndListener = function(element) {
        element.off('keydown.cie.end').on('keydown.cie.end', function(e) {
            if (!isModifierPressed(e)) {
                if (e.keyCode == keyCodes.end) {
                    $(e.target).trigger(events.end, [{originalEvent: e}]);
                }
            }
        });
    };
    ...
    var addNextListener = function(element) {
        ...
        element.off('keydown.cie.next').on('keydown.cie.next', function(e) {
            if (!isModifierPressed(e)) {
                if (e.keyCode == keyCode) {
                    $(e.target).trigger(events.next, [{originalEvent: e}]);
                }
            }
        });
    };
    ...
    var addPreviousListener = function(element) {
        ...
        element.off('keydown.cie.previous').on('keydown.cie.previous', function(e) {
            if (!isModifierPressed(e)) {
                if (e.keyCode == keyCode) {
                    $(e.target).trigger(events.previous, [{originalEvent: e}]);
                }
            }
        });
    };
    ...
    var addAsterixListener = function(element) {
        element.off('keydown.cie.asterix').on('keydown.cie.asterix', function(e) {
            if (!isModifierPressed(e)) {
                if (e.keyCode == keyCodes.asterix) {
                    $(e.target).trigger(events.asterix, [{originalEvent: e}]);
                }
            }
        });
    };
     ...
     * @method getHandlers
     * @private
     * @return object key of event names and value of handler functions
     */
     ...
     * @param include the array of events to be triggered
     */
