...
define(['jquery', 'core/modal_events', 'core/modal', 'core/modal_save_cancel', 'core/templates',
     ...
     * @param {jQuery object} triggerElement The element to open the modal
     */
     ...
     * @param {jQuery object} modalElement The modal HTML element
     * @param {jQuery object} triggerElement The trigger HTML element
     ...
     * @param {string} type A modal type (see TYPES)
     * @param {jQuery object} triggerElement The trigger HTML element
     * @return {jQuery promise} Resolved with a Modal instance
     */
