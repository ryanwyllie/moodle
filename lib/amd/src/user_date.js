 ...
 */
define(['jquery', 'core/ajax', 'core/sessionstorage'], function($, Ajax, Storage) {
    ...
    var getKey = function(request) {
        return 'core_user_date/' + request.timestamp + '/' + request.format;
    };
    ...
    return {
        /**
         * Takes a single request object or an array of request objects
         * and returns a promise that is resolved with an array of
         * formatted dates.
         *
         * The values in the returned array will be ordered the same as
         * the request array.
