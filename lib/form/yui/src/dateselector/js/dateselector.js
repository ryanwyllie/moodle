...
M.form.dateselector = {
    ...
    fix_position: function() {
        if (this.currentowner) {
            var selectNode = this.currentowner.get('node').one('select');
            var alignpoints = [
            ...
            // Re-align if the panel is rendered above the top of the viewport.
            // This happens when the date selector is rendered inside a modal.
            if (this.panel.get('y') < 0) {
                if (window.right_to_left()) {
                    // Align the top right of the panel with the bottom right
                    ...
                    // Align the top left of the panel with the bottom left
                    // of the select element.
                    alignpoints = [
                        Y.WidgetPositionAlign.TL,
                        Y.WidgetPositionAlign.BL
