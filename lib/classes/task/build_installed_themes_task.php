...
/**
 * Class that builds and caches all of the site's installe themes.
 *
 * Custom data accepted:
 * - themes -> Array of theme names to build.
 *
 * @package     core
 * @copyright   2017 Ryan Wyllie <ryan@moodle.com>
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class build_installed_themes_task extends adhoc_task {
    ...
    public function execute() {
        ...
        $themenames = [];
        if (isset($this->get_custom_data()->themes)) {
            // Use given theme names.
            $themenames = $this->get_custom_data()->themes;
        } else {
            // Default to all themes if none were specified.
