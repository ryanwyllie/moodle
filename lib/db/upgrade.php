...
function xmldb_main_upgrade($oldversion) {
    ...
    if ($oldversion < 2017020900.04) {
        ...
        upgrade_main_savepoint(true, 2017020900.04);
    }

    if ($oldversion < 2017020900.05) {
        ...
        upgrade_main_savepoint(true, 2017020900.05);
    }

    if ($oldversion < 2017020900.06) {
        ...
        upgrade_main_savepoint(true, 2017020900.06);
    }
