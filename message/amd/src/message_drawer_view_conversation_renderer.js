...
function(
    ...
    var renderConversation = function(header, body, footer, data) {
        ...
        if (timestampsToFormat.length) {
            ...
            // individual requests.
            var datesCachePromise = Str.get_string('strftimetime24', 'core_langconfig')
    ...
    var renderHeader = function(header, body, footer, data) {
        ...
        var template = data.type == CONVERSATION_TYPES.PRIVATE ? TEMPLATES.HEADER_PRIVATE : TEMPLATES.HEADER_PUBLIC;
        ...
        if (user) {
            return Str.get_string('userwouldliketocontactyou', 'core_message', user.fullname)
                .then(function(string) {
                    ...
                    return showConfirmDialogue(body, footer, buttonSelectors, string, '', false);
                });
        } else {
            return hideConfirmDialogue(body, footer);
        }
    ...
    var renderReset = function(header, body, footer) {
        hideConfirmDialogue(body, footer);
