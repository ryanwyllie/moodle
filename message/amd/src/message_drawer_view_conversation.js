...
function(
    ...
    var loadEmptyPrivateConversation = function(loggedInUserProfile, otherUserId) {
        ...
        return render(newState)
            .then(function() {
                return Repository.getMemberInfo(loggedInUserId, [otherUserId]);
            })
    ...
    var show = function(header, body, footer, conversationOrId, action, otherUserId) {
        ...
        if (isNewConversation) {
            ...
            if (conversation) {
                var renderPromise = resetByConversation(body, conversation, loggedInUserProfile, otherUserId);
            } else if (conversationId) {
                var renderPromise = resetById(body, conversationId, loggedInUserProfile, otherUserId);
            } else {
                var renderPromise = resetNoConversation(body, loggedInUserProfile, otherUserId);
            }
