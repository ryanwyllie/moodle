...
$conversations = \core_message\api::get_conversations($user1);
$messages = null;
if ($user2realuser) {
    $messages = \core_message\api::get_messages($user1, $user2);
}
$messagearea = new \core_message\output\message_area_page($conversations, $messages);
