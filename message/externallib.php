...
class core_message_external extends external_api {
    ...
    public static function data_for_messagearea_search_people_in_course_parameters() {
        return new external_function_parameters(
            array(
                ...
                'search' => new external_value(PARAM_ALPHANUMEXT, 'The string being searched'),
                'limitfrom' => new external_value(PARAM_INT, 'Limit from', VALUE_DEFAULT, 0),
                'limitnum' => new external_value(PARAM_INT, 'Limit number')
            )
        );
    }
     ...
     * @since 3.2
     */
    public static function data_for_messagearea_search_people_in_course($userid, $courseid, $search, $limitfrom, $limitnum) {
        global $CFG, $PAGE;
     ...
     * @since 3.2
     */
    public static function data_for_messagearea_search_people($userid, $search, $limitnum) {
        global $CFG, $PAGE;
     ...
     * @since 3.2
     */
    public static function data_for_messagearea_search_messages($userid, $search, $limitfrom, $limitnum) {
        global $CFG, $PAGE;
                ...
                'contacts' => new external_multiple_structure(
                    new external_single_structure(
                        array(
                            ...
                            'searchmessageid' => new external_value(PARAM_INT, 'The unique search message id'),
