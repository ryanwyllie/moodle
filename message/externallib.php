...
class core_message_external extends external_api {
     ...
     * @since Moodle 3.6
     */
    private static function get_conversation_structure(bool $includecontactrequests = false) {
        return new external_single_structure(
            array(
                ...
                'members' => new external_multiple_structure(
                    self::get_conversation_member_structure($includecontactrequests)
                ),
                'messages' => new external_multiple_structure(
    ...
    private static function get_conversation_member_structure(bool $includecontactrequests = false,
        ...
        $result = [
            ...
            // TODO: DELETE ME
            'canmessage' => new external_value(PARAM_BOOL, '', VALUE_OPTIONAL),
            'requirescontact' => new external_value(PARAM_BOOL, '', VALUE_OPTIONAL),
        ];
     ...
     * @throws moodle_exception if messaging is disabled or if the user cannot perform the action.
     */
    public static function get_member_info(int $referenceuserid, array $userids) {
        global $CFG, $USER;
        ...
        return \core_message\helper::get_member_info($referenceuserid, $userids);
    }
