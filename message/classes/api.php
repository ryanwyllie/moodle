...
class api {
    ...
    public static function get_conversation(
        ...
        $convsubnames = self::get_linked_conversation_subnames([$conversation]);
        $subname = isset($convsubnames[$conversationid]) ? $convsubnames[$conversationid] : null;
     ...
     * @param bool $includefavourites Include favourite conversations
     * @return int the count of the user's unread conversations
     */
    public static function count_conversations($user, int $type = null, bool $includefavourites = true) {
        global $DB;
