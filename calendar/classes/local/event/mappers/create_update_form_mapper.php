...
/**
 * Event create_update form mapper.
 *
...
/**
 * Event create_update form mapper class.
 *
 * @copyright 2017 Ryan Wyllie <ryan@moodle.com>
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class create_update_form_mapper {

    /**
     * Generate the appropriate data for the event_form from a legacy event.
     *
    ...
    /**
     * Generate the appropriate \calendar_event properties from the event_form data.
     *
