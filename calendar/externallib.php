...
class core_calendar_external extends external_api {
     ...
     * @param int $limitfrom Offset the results by this value
     * @param int $limitnum Limit the number of results to this value
     * @return array
     */
    public static function get_calendar_action_events_by_timesort($timesortfrom = null, $timesortto = null,
        ...
        return array_map(function($event) use ($renderer) {
            return (new \core_calendar\output\event($event))->export_for_template($renderer);
        }, $events);
    }
    ...
    public static function get_calendar_action_events_by_timesort_returns() {
        return new external_multiple_structure(
            self::get_calendar_event_structure()
        );
    }
