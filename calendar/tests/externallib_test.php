...
class core_calendar_externallib_testcase extends externallib_advanced_testcase {
    ...
    function test_get_calendar_action_events_by_timesort_after_time() {
        ...
        $result = core_calendar_external::get_calendar_action_events_by_timesort($user->id, 5);
        ...
        $result = core_calendar_external::get_calendar_action_events_by_timesort($user->id, 9);
        $result = external_api::clean_returnvalue(
            core_calendar_external::get_calendar_action_events_by_timesort_returns(),
            $result
        );
    ...
    function test_get_calendar_action_events_by_timesort_before_time() {
        ...
        $result = core_calendar_external::get_calendar_action_events_by_timesort($user->id, null, 5);
        $result = external_api::clean_returnvalue(
            core_calendar_external::get_calendar_action_events_by_timesort_returns(),
            $result
        );
        ...
        $result = core_calendar_external::get_calendar_action_events_by_timesort($user->id, null, 1);
        $result = external_api::clean_returnvalue(
            core_calendar_external::get_calendar_action_events_by_timesort_returns(),
            $result
        );
    ...
    function test_get_calendar_action_events_by_timesort_time_range() {
        ...
        $result = core_calendar_external::get_calendar_action_events_by_timesort($user->id, 3, 6);
        $result = external_api::clean_returnvalue(
            core_calendar_external::get_calendar_action_events_by_timesort_returns(),
            $result
        );
        ...
        $result = core_calendar_external::get_calendar_action_events_by_timesort($user->id, 10, 15);
        $result = external_api::clean_returnvalue(
            core_calendar_external::get_calendar_action_events_by_timesort_returns(),
            $result
        );
    ...
    function test_get_calendar_action_events_by_timesort_time_limit_offset() {
        ...
        $result = core_calendar_external::get_calendar_action_events_by_timesort($user->id, 2, 7, $event3->id, 2);
        $result = external_api::clean_returnvalue(
            core_calendar_external::get_calendar_action_events_by_timesort_returns(),
            $result
        );
        ...
        $result = core_calendar_external::get_calendar_action_events_by_timesort($user->id, 2, 7, $event5->id, 2);
        $result = external_api::clean_returnvalue(
            core_calendar_external::get_calendar_action_events_by_timesort_returns(),
            $result
        );
        ...
        $result = core_calendar_external::get_calendar_action_events_by_timesort($user->id, 2, 7, $event7->id, 2);
        $result = external_api::clean_returnvalue(
            core_calendar_external::get_calendar_action_events_by_timesort_returns(),
            $result
        );
