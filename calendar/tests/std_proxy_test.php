...
class core_calendar_std_proxy_testcase extends advanced_testcase {
    /**
     * @static \stdClass[] $objects Array of objects to proxy.
     */
    ...
    public function test_proxy($id, $member, $expected) {
        ...
        $this->assertEquals($proxy->{$member}, $expected);
    }

    /**
     * Test getting.
     *
     * @dataProvider test_get_testcases()
     * @param int $id Object ID.
     */
    public function test_get($id) {
        ...
        $this->assertEquals($proxy->get(), self::$objects[$id]);
    }
    ...
    /**
     * Test cases for getting test.
     */
    public function test_get_testcases() {
        return [
            'Object 1' => [1],
            'Object 2' => [5]
        ];
