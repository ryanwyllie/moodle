...
class core_calendar_event_testcase extends advanced_testcase {
    ...
    public function test_getters($constructorparams) {
        $event = new action_event(...array_values($constructorparams));
 ...
 * A test event.
 */
final class test_event implements event_interface {
...
/**
 * A test event collection.
 */
final class test_event_collection implements event_collection_interface {
    private $events;
...
/**
 * A test course module.
 */
final class test_course_module implements course_module_interface {
    public function get_name() {
        return 'My name Jeff';
    }
