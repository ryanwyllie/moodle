...
class mod_choice_lib_testcase extends externallib_advanced_testcase {
     ...
     */
    public function test_mod_choice_core_calendar_validate_event_no_activity() {
        global $CFG;
        ...
        mod_choice_core_calendar_validate_event($event);
    }

    /**
     * A CHOICE_EVENT_TYPE_OPEN must be before the close time of the choice activity.
     */
    public function test_mod_choice_core_calendar_validate_event_valid_open_event() {
        global $CFG, $DB;
        require_once($CFG->dirroot . "/calendar/lib.php");
        ...
        $this->assertTrue(mod_choice_core_calendar_validate_event($event));
    }
     ...
     */
    public function test_mod_choice_core_calendar_validate_event_invalid_open_event() {
        global $CFG, $DB;
        require_once($CFG->dirroot . "/calendar/lib.php");
     ...
     */
    public function test_mod_choice_core_calendar_validate_event_valid_close_event() {
        global $CFG, $DB;
        require_once($CFG->dirroot . "/calendar/lib.php");
     ...
     * of the choice activity.
     */
    public function test_mod_choice_core_calendar_validate_event_invalid_close_event() {
        global $CFG, $DB;
        require_once($CFG->dirroot . "/calendar/lib.php");
     ...
     */
    public function test_mod_choice_core_calendar_event_updated_unknown_event() {
        global $CFG, $DB;
        require_once($CFG->dirroot . "/calendar/lib.php");
        ...
        mod_choice_core_calendar_event_updated($event);
     ...
     * the choice activity.
     */
    public function test_mod_choice_core_calendar_event_updated_open_event() {
        global $CFG, $DB;
        require_once($CFG->dirroot . "/calendar/lib.php");
     ...
     * the choice activity.
     */
    public function test_mod_choice_core_calendar_event_updated_close_event() {
        global $CFG, $DB;
        require_once($CFG->dirroot . "/calendar/lib.php");
