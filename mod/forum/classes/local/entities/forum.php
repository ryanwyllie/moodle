...
class forum {
     ...
     * @param bool $forcesubscription Does the forum force users to subscribe?
     ...
     * @param bool $displaywordcounts Should display word counts in posts
     * @param bool $lockdiscussionafter Timestamp after which discussions should be locked
     */
