...
$string['postthresholdexceeded'] = 'Post threshold exceeded';
$string['postthresholdexceededlong'] = 'You have exceeded the posting threshold set for this forum. Please try again in {$a} day(s).';
