...
class managers_capability_testcase extends advanced_testcase {
    ...
    public function test_can_create_discussions() {
        ...
        $forumrecord = $this->getDataGenerator()->create_module('forum', ['course' => $this->course->id, 'groupmode' => SEPARATEGROUPS]);
    ...
    public function test_can_post_in_discussion() {
        ...
        $forumrecord = $this->getDataGenerator()->create_module('forum', ['course' => $this->course->id, 'groupmode' => VISIBLEGROUPS]);
        $coursemodule = get_coursemodule_from_instance('forum', $forumrecord->id);
        $context = context_module::instance($coursemodule->id);
        $forum = $this->entityfactory->get_forum_from_stdClass(
            $forumrecord,
