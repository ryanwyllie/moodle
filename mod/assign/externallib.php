...
class mod_assign_external extends external_api {
    ...
    public static function get_participant($assignid, $userid, $embeduser) {
        ...
        $return = array(
            ...
            'allowsubmissionsfromdate' => $assign->get_instance($params['userid'])->allowsubmissionsfromdate,
            'duedate' => $assign->get_instance($params['userid'])->duedate,
            'cutoffdate' => $assign->get_instance($params['userid'])->cutoffdate,
            'duedatestr' => userdate($assign->get_instance($params['userid'])->duedate, get_string('strftimedatetime', 'langconfig')),
        );
