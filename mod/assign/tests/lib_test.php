...
class mod_assign_lib_testcase extends mod_assign_base_testcase {
    ...
    public function test_assign_is_override_calendar_event_no_override() {
        ...
        $this->assertFalse(assign_is_override_calendar_event($event));
    }
    ...
    public function test_assign_is_override_calendar_event_user_override() {
        ...
        $this->assertTrue(assign_is_override_calendar_event($event));
    }
     ...
     * event function.
     */
    public function test_mod_assign_core_calendar_validate_event_no_instance_id() {
        global $CFG;
        require_once($CFG->dirroot . '/calendar/lib.php');
        ...
        mod_assign_core_calendar_validate_event($event);
     ...
     */
    public function test_mod_assign_core_calendar_validate_event_no_instance_found() {
        global $CFG;
        require_once($CFG->dirroot . '/calendar/lib.php');
     ...
     * throw an exception.
     */
    public function test_mod_assign_core_calendar_validate_event_no_limit() {
        global $CFG, $DB;
        require_once($CFG->dirroot . '/calendar/lib.php');
     ...
     */
    public function test_mod_assign_core_calendar_event_updated_non_due_event() {
        global $CFG, $DB;
        require_once($CFG->dirroot . '/calendar/lib.php');
        ...
        mod_assign_core_calendar_event_updated($event);
     ...
     */
    public function test_mod_assign_core_calendar_event_updated_due_event_override() {
        global $CFG, $DB;
        require_once($CFG->dirroot . '/calendar/lib.php');
     ...
     */
    public function test_mod_assign_core_calendar_event_updated_due_event() {
        global $CFG, $DB;
        require_once($CFG->dirroot . '/calendar/lib.php');
    ...
    public function test_student_role_cant_update_due_event() {
        ...
        $this->setUser($user);
        $event->update(['timestart' => $newduedate]);
        ...
        // event.
        $this->assertEquals($duedate, $newinstance->duedate);
        $this->assertEquals($newduedate, $newevent->timestart);
    }
    ...
    public function test_teacher_role_can_update_due_event() {
        ...
        $newinstance = $DB->get_record('assign', ['id' => $instance->id]);
        $newevent = \calendar_event::load($event->id);
        // The due date should be updated because the user has the correct
        // capabilities.
        $this->assertEquals($newduedate, $newinstance->duedate);
        $this->assertEquals($newduedate, $newevent->timestart);
    }
