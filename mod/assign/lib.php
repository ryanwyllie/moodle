...
function mod_assign_transform_event(
    \core_calendar\local\interfaces\event_interface $event,
    \core_calendar\local\interfaces\action_event_factory_interface $factory
) {
    global $USER, $CFG;
    require_once($CFG->dirroot . '/mod/assign/locallib.php');
    $coursemodule = $event->get_course_module()->get_proxied_instance();
    $context = context_module::instance($coursemodule->id);;
