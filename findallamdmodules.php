...
/**
 * Returns a JSON encoded list of AMD source files and their component names.
 *
 * @copyright  2018 Ryan Wyllie <ryan@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

// Don't allow access to this from the webserver. It's a helper script for
// the babel transpiler only.
