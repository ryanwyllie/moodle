...
define(
    ...
    function(
        ...
        var registerEventListeners = function(root) {
            ...
            root.on(CustomEvents.events.activate, SELECTORS.PAGING_BAR_NEXT, function(e) {
            ...
            root.on(CustomEvents.events.activate, SELECTORS.PAGING_BAR_PREVIOUS, function(e) {
