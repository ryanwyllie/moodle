...
function(
     ...
     * @param {int} startTime Timestamp to load events after.
     ...
     * @param {int} midnight The midnight timestamp in the user's timezone.
     * @param {int} daysOffset Number of days from today to offset the events.
     * @param {int} daysLimit Number of days from today to limit the events to.
