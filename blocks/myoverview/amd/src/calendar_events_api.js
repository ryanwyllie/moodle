 ...
 *
 * @module     block_myoverview/calendar_events_api
 * @class      repository
...
define(['jquery'], function($) {
    ...
    var queryForUserByDays = function(startDay, endDat, limit, offset) {
        var promise = $.Deferred();

        setTimeout(function() {
            promise.resolve(dataCache.slice(offset, offset + limit));
        }, 1000);
