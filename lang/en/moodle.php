...
$string['relativedatesmode_help'] = 'Display course or activity dates relative to the user\'s start date in the course.<br/>If set to "Yes", the user\'s course start date will be the enrolment start date if it is on or after the course start date. Otherwise, the course start date will be the user\'s course start date.<br/><strong>WARNING: This is an experimental feature and not all activities may support it. Once the course has been created, this course setting can no longer be changed.</strong>';
$string['relativedatesmode_warning'] = '<span><strong>Warning</strong> This cannot be changed once the course has been created.</span>';
