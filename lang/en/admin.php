...
$string['environmentrecommendversionunsupported'] = 'version from {$a->needed} and less than {$a->unsupported} is recommended and you are running {$a->current}';
...
$string['environmentrequireversionunsupported'] = 'version from {$a->needed} and less than {$a->unsupported} is required and you are running {$a->current}';
