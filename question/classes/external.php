...
class core_question_external extends external_api {
    ...
    public static function get_random_question_summaries(
        ...
        $formattedquestions = array_map(function($question) use ($categorycontext, $renderer) {
            $exporter = new \core_question\external\question_summary_exporter($question, ['context' => $categorycontext]);
